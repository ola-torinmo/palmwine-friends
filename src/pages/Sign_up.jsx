  ...
  return (
   <>
    <main
        className={`w-screen`}
      >
        <section className="h-screen md:h-[1290px] md:bg-contain bg-contain bg-center bg-no-repeat  bg-gray-500 bg-blend-multiply hidden md:block  " style={{ backgroundImage: `url(${backgroundImage})` }}>
         ...
         {/* smaller screens */}
        <section className="h-screen md:h-[1290px] md:bg-contain bg-contain bg-center bg-no-repeat  bg-gray-500 bg-blend-multiply md:hidden mt-[-30%] se:mt-[90%]  " style={{ backgroundImage: `url(${backgroundImage2})` }}>
        
          <div className="pt-[54%] ">
          <img src={logo} alt='' className="  ml-[3.5%]  md:w-[90px] w-[50px] md:h-[70px] h-[30px]"/>
          </div>
        ...
        <div className="" >
          ...
          <div className="md:ml-[70%] ml-[82%] md:mt-[25%] mt-[] ">
            ...
            <div className="">
                ...
                <form  onSubmit={submitHandler}  className=" md:mx-[25%] mx-[21%] md:mt-[-25%] mt-[-39%] ip12:mt-[-44%] ip14:mt-[-36%] se:mt-[-70%]" style={{ fontFamily: 'moderat' }}>
